...
!(function (a) {
  var b = (function (a, b, c) {
    ...
    return (function () {
      ...
      a.intlTelInputGlobals = { instances: {} };
      var i = 0,
        j = { allowDropdown: !0, autoHideDialCode: !0, autoPlaceholder: 'polite', customPlaceholder: null, dropdownContainer: null, excludeCountries: [], formatOnDisplay: !0, geoIpLookup: null, hiddenInput: '', initialCountry: '', localizedCountries: null, nationalMode: !0, onlyCountries: [], placeholderNumberType: 'MOBILE', preferredCountries: ['us', 'gb'], separateDialCode: !1, utilsScript: '' },
              ...
              },
              {
                ...
                value: function () {
                  ...
                  if (
                    ...
                    this.d.separateDialCode && (this.t = this._e2('div', { class: 'selected-dial-code' }, this.selectedFlag)),
                    this.d.allowDropdown &&
                      (this.selectedFlag.setAttribute('tabindex', '0'),
                      (this.u = this._e2('div', { class: 'iti-arrow' }, this.selectedFlag)),
                      (this.m = this._e2('ul', { class: 'country-list hide', id: 'country-listbox', 'aria-expanded': 'false', role: 'listbox' })),
      ...
      return (
        ...
        (a.intlTelInputGlobals.version = '14.0.7'),
        function (b, c) {
          var d = new n(b, c);
